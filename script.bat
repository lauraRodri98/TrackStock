...
start cmd /k "cd /d C:\Escritorio-Laura\Proyectos\inventario-productos\Inventario-GitHub\Backend && npm start"

:: Abrir terminal para el Frontend
start cmd /k "cd /d C:\Escritorio-Laura\Proyectos\inventario-productos\Inventario-GitHub\nextjs-dashboard && pnpm run dev"
